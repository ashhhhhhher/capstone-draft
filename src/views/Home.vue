...
import CurrentEvent from '../components/DGM Components/CurrentEvent.vue'
import AttendanceStats from '../components/DGM Components/AttendanceStats.vue'
import Modal from '../components/DGM Components/Modal.vue'
import CreateEventForm from '../components/DGM Components/CreateEventForm.vue'
import AttendanceListModal from '../components/DGM Components/AttendanceListModal.vue'
import EventListModal from '../components/DGM Components/EventListModal.vue'
import CalendarModal from '../components/DGM Components/CalendarModal.vue' 
import AbsenceMonitoring from '../components/DGM Components/AbsenceMonitoring.vue'
